  ...
  return (
    <footer className="py-8">
      <div className="max-w-6xl xl:max-w-6xl mx-auto divide-y divide-gray-200 px-4 sm:px-6 md:px-8">
        ...
        <ul className="Footer_nav__2rFid text-sm font-medium  sm:pb-20 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-10">
          <li className="space-y-5 row-span-2">
            <Image src="/logo-v.png" width="160" height="60" />
            <p className="text-gray-400 pr-4">We are committed to ensuring that everyone has a happy home.</p>
          </li>
          <li className="space-y-5 row-span-2">
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-4 border-t lg:flex-row bg-top border-black">
          ...
          <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
            ...
            >
              © 2021 <span className="text-blue-500">Haven</span>
            </a>
          </ul>
        </div>
      </div>
